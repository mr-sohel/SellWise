...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/Gantt Chart Diagram.drawio.svg"}
    \caption{Gantt Chart}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/DFD LEVEL0 Diagram.drawio.svg"}
    \caption{Context Level DFD (Level 0)}
\end{figure}

\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/DFD LEVEL 1 Diagram.drawio.svg"}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/ER Diagram.drawio.svg"}
    \caption{ER Diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/USE CASE Diagram.drawio.svg"}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/New_06_Activity_Diagram.svg"}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/new sequence Diagram.drawio.svg"}
...
\begin{figure}[H]
    \centering
    \includesvg[width=\textwidth,height=0.85\textheight,keepaspectratio]{"diagrams/Class Diagram.drawio.svg"}
