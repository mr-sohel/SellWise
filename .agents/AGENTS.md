# SellWise — Project Context for Antigravity/Gemini Agents
...
- **Reference:** See `aspnet_core_strategy.md` (in `.gemini/antigravity-cli/brain/...` artifacts) for architecture mapping and project structure
